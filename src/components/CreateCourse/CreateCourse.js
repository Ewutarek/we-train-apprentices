...
export default class CreateCourse extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      courseNames: ["Softawre Developer", "Software Tester", "Project Management", "Business Analyst", "Data Fellowship","Digital Marketing" ],
      courseNameVal: "Software Developer",
      courseLevels: ["Level 3", "Level 4", "Bachelors Degree", "Masters Degree"],
